    ...
    <>
      ...
      <section className="pb_120">
        ...
        >
          ...
          >
            <img
              src="./assets/img/protfolio/prot-detailsbig.png"
              alt="img"
              className="w-full"
            />
            <div
              className="bg-[rgb(18_18_18)] rounded-tr-[30px] xl:p-[45px] lg:p-6 py-5 px-[12px] lg:absolute static bottom-0 left-0 w-full lg:w-auto"
            >
              <h3
                className="text-white xl:mb-8 mb-6 capitalize sm:text-[32px] text-[26px] leading-[120%] font-semibold"
              >
                Project Info
              </h3>
              <div className="flex lg:gap-[100px] gap-5 xl:mb-9 mb-[22px]">
                <div>
                  <div className="xl:mb-[30px] mb-[14px]">
                    <h5
                      className="font-medium text-white xl:mb-[10px] lg:mb-[5px] mb-[10px] capitalize text-xl leading-[130%]"
                    >
                      Clients
                    </h5>
                    <p className="text-clr_pra lg:text-base text-sm">Nicolas Marko</p>
                  </div>
                  <div className="xl:mb-[30px] mb-[14px]">
                    <h5
                      className="font-medium text-white xl:mb-[10px] lg:mb-[5px] mb-[10px] capitalize text-xl leading-[130%]"
                    ...
                    <p className="text-clr_pra lg:text-base text-sm">Sept 19, 2023</p>
                  </div>
                </div>
                <div>
                  <div className="xl:mb-[30px] mb-[14px]">
          ...
          <div>
            ...
            >
              <h3
                className="xl:text-[32px] xl:mb-[30px] mb-5 text-[26px] text-white capitalize font-semibold"
              >
                Challenge
              </h3>
              <p className="xl:mb-7 mb-[15px] text-clr_pra">
              ...
              <ul className="">
                <li
                  className="flex items-center gap-[10px] relative text-base text-clr_pra sm:pl-4 xl:mb-5 mb-[10px]"
                >
                  <span
                    className="min-w-[6px] h-[6px] rounded-full bg-clr_base"
                  ></span>
                  <span>
                ...
                <li
                  className="flex items-center gap-[10px] relative text-base text-clr_pra sm:pl-4"
                >
                  <span
                    className="min-w-[6px] h-[6px] rounded-full bg-clr_base"
                  ></span>
            ...
            >
              <div className="w-full">
                <img
                  src="./assets/img/protfolio/prot-detials1.png"
                  alt="img"
              ...
              <div className="w-full">
                <img
                  src="./assets/img/protfolio/prot-detials2.png"
                  alt="img"
                  className="rounded-lg w-full"
                />
              </div>
